...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		else if (encontrarUsuario(u) == 201)
			MessageBox::Show("Puntero nulo", "Info", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
		else if (encontrarUsuario(u) == 202)
			MessageBox::Show("Fin de archivo", "Info", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
		else
